 ...
 * 
 */
@WebServiceClient(name = "Servicios", targetNamespace = "http://WebService/", wsdlLocation = "http://localhost:8080/ServicioWebInstitucion/Servicios?wsdl")
    ...
    extends Service
{
    ...
    private final static QName SERVICIOS_QNAME = new QName("http://WebService/", "Servicios");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/ServicioWebInstitucion/Servicios?wsdl");
    ...
    public Servicios getServiciosPort() {
        return super.getPort(new QName("http://WebService/", "ServiciosPort"), Servicios.class);
    }
    ...
    public Servicios getServiciosPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://WebService/", "ServiciosPort"), Servicios.class, features);
    }
